package com.example.trainingdiary.ui.custom_exercise_adapter
...
import com.example.trainingdiary.ui.custom_exercise_adapter.inner_custom_exercise_adapter.InnerCustomExerciseAdapter
...
class CustomExerciseAdapter :
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun onBind(customExercises: CustomExercises) {
